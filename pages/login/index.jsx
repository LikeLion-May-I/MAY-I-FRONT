  ...
  return (
    <>
      ...
      <section className="container max-w-[1000px] flex px-36 mx-auto py-12">
        <div className="w-full mt-12 p-16 rounded shadow-2xl text-center">
          ...
          <button className="mt-3 px-5 py-2 text-center text-white bg-indigo-300 hover:bg-indigo-500 font-bold rounded-full">
            Login
          </button>
          <p className="text-center my-6 text-gray-400 text-md">Social Login</p>
