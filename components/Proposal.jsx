        ...
        <div className="container px-4">
          <div className="overflow-hidden bg-white rounded-md shadow-2xl p-3">
            <div className="border-coolGray-100">
              <div className="flex flex-wrap items-center justify-center mb-6">
                <div className="w-full md:w-auto p-2 text-center">
                  <h2 className="text-coolGray-900 font-semibold text-3xl">
                    May I 제안서
                  </h2>
                </div>
              ...
              <div className="w-full md:w-9/12">
                <div className="flex flex-wrap -m-3">
                  ...
                  <div className="w-full md:w-1/3 p-3 md:flex-1">
                    <p className="w-full px-4 text-base font-normal outline-none text-black py-2">
                      김산보
                    </p>
                  </div>
                </div>
              ...
              <div className="w-full md:w-9/12">
                <div className="flex flex-wrap -m-3">
                  ...
                  <div className="md:flex-1 p-3">
                    <input
                      className="w-full px-4 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input py-2"
                      type="text"
                      placeholder="백신여권, 한국에도 도입해야 하는가?"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="w-full md:w-9/12">
                <div className="flex flex-wrap -m-3">
                  ...
                  <div className="w-full p-3 md:flex-1">
                    <input
                      className="w-full px-4 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg py-2"
                      type="text"
                      placeholder="전문가 의견 기고"
                    />
                  </div>
                </div>
              </div>
                    ...
                    <div class="border border-coolGray-200 rounded-lg">
                      <div class="flex px-4 py-2 space-x-2">
                        <Image
                          ...
                          height={18}
                        />
                        <p class="w-full text-base font-normal outline-none text-red-600">
                          한번 전송하면 취소할 수 없어요. 신중하게 작성해주세요.
                        </p>
                      </div>
                      <div class="flex px-4 py-2 space-x-2">
                        <Image
            ...
            <div class="py-4 flex justify-center space-x-4">
              <button class="border p-2 w-28 rounded-full text-black">
                임시저장
              </button>
              <button class="border bg-violet-300 p-2 w-28 rounded-full text-black">
                전송
              </button>
            </div>
          </div>
